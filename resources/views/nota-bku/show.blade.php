    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('nota-bku.cetak', $notaBku) }}" target="_blank" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-slate-800">{{ $notaBku->kegiatan->kode ?? '-' }} {{ $notaBku->kegiatan->nama ?? '-' }}</div>
                        </div>
                        <div>
        ...
        <div class="space-y-6">
                ...
                <div class="card-body space-y-4">
                    ...
                    <div class="stat-card blue">
                        <div class="stat-icon bg-blue-50">
                            <svg aria-hidden="true" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4"/></svg>
                        </div>
                        <div>
            ...
            @if($notaBku->transaksiBkus->isNotEmpty())
                <div class="card">
                    <div class="card-header">
                        <span class="card-title">Transaksi Terkait</span>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="data-table">
                            <thead>
