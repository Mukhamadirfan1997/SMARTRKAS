    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('import-revisi.index') }}" class="sidebar-link {{ request()->routeIs('import-revisi.*') ? 'active' : '' }}">
            <svg aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
            <span class="nav-text">Import Revisi / PAK</span>
        </a>
        ...
        <a href="{{ route('transaksi-template.index') }}" class="sidebar-link {{ request()->routeIs('transaksi-template.*') ? 'active' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('pengaturan-sekolah.*') || request()->routeIs('profile.*') || request()->routeIs('pengaturan.backup.*') || request()->routeIs('pengaturan.audit.*') || request()->routeIs('pengaturan.recovery-code.*') || request()->routeIs('pengaturan.telegram.*') || request()->routeIs('pengaturan.kategori-juknis.*') || request()->routeIs('tentang.*') ? 'true' : 'false' }} }">
            ...
            <div class="sidebar-submenu" x-show="open" x-transition>
                ...
                <a href="{{ route('pengaturan.kategori-juknis.index') }}" class="{{ request()->routeIs('pengaturan.kategori-juknis.*') ? 'text-white bg-white/5' : '' }}">
                    <svg aria-hidden="true" class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><circle cx="10" cy="10" r="3"/></svg>
                    <span class="nav-text">Kategori Juknis BOSP</span>
                </a>
