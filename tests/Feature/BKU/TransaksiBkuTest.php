...
class TransaksiBkuTest extends TestCase
{
    ...
    public function test_store_skips_soft_deleted_no_bukti_when_autogenerating(): void
    {
        // Buat transaksi dengan NPSN yang sama dgn test env (00000000, karena
        // tidak ada PengaturanSekolah di test), lalu soft-delete.
        $deleted = $this->makeTransaksi([
            'tanggal' => '2026-01-10',
            'bulan' => 1,
            'jenis' => 'penerimaan',
            'no_bukti' => 'BBU001/00000000/01/2026',
            'jumlah' => 100000,
        ]);
        $deleted->delete();
        ...
        // Penomoran per tahun — BBU001 sudah dipakai (soft-deleted) -> lanjut BBU002.
        $this->assertSame('BBU002/00000000/01/2026', $new->no_bukti);
    }
